...
trait ModelFitConfig extends js.Object {
  ...
  var validationData: js.Tuple2[TensorND | js.Array[TensorND], TensorND | js.Array[TensorND]] | js.Tuple3[TensorND | js.Array[TensorND], TensorND | js.Array[TensorND], TensorND | js.Array[TensorND]] = js.native
...
class Model protected () extends Container {
  ...
  def standardizeUserData(x: TensorND | js.Array[TensorND] | js.Dictionary[TensorND], y: TensorND | js.Array[TensorND] | js.Dictionary[TensorND], checkBatchAxis: Boolean = ???, batchSize: Double = ???): js.Tuple3[js.Array[TensorND], js.Array[TensorND], js.Array[TensorND]] = js.native
...
object Training extends js.Object {
  def isDataTensor(x: TensorND | js.Array[TensorND] | js.Dictionary[TensorND] | js.Dictionary[js.Array[TensorND]]): Boolean = js.native
  ...
  def standardizeInputData(data: TensorND | js.Array[TensorND] | js.Dictionary[TensorND], names: js.Array[String], shapes: js.Array[Shape] = ???, checkBatchAxis: Boolean = ???, exceptionPrefix: String = ???): js.Array[TensorND] = js.native
  def checkArrayLengths(inputs: js.Array[TensorND], targets: js.Array[TensorND], weights: js.Array[TensorND] = ???): Unit = js.native
  def makeBatches(size: Double, batchSize: Double): js.Array[js.Tuple2[Double, Double]] = js.native
  def sliceArraysByIndices(arrays: TensorND | js.Array[TensorND], indices: Tensor1D): TensorND | js.Array[TensorND] = js.native
}
