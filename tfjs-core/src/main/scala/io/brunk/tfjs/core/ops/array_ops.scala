...
package array_ops {
  ...
  object Array_ops extends js.Object {
    ...
    def eye_(
        numRows: Double,
        numColumns: Double = ???,
        batchShape: js.Tuple1[Double] | js.Tuple2[Double, Double] | js.Tuple3[
          Double,
          Double,
          Double
    ...
    def stack_[T <: Tensor](
        tensors: js.Array[T] | js.Array[TensorLike],
        axis: Double = ???
    ): Tensor = js.native
    def batchToSpaceND_[T <: Tensor](
        x: T | TensorLike,
        blockShape: js.Array[Double],
        crops: js.Array[js.Array[Double]]
    ): T = js.native
    def spaceToBatchND_[T <: Tensor](
        x: T | TensorLike,
        blockShape: js.Array[Double],
