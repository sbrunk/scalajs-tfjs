...
trait OpHandler extends js.Object {
  ...
  def all[T <: Tensor](x: Tensor, axis: Double | js.Array[Double], keepDims: Boolean): T = js.native
  def any[T <: Tensor](x: Tensor, axis: Double | js.Array[Double], keepDims: Boolean): T = js.native
  ...
  def batchToSpaceND[T <: Tensor](x: T, blockShape: js.Array[Double], crops: js.Array[js.Array[Double]]): T = js.native
  def spaceToBatchND[T <: Tensor](x: T, blockShape: js.Array[Double], paddings: js.Array[js.Array[Double]]): T = js.native
}
...
class Tensor[R <: Rank] protected () extends js.Object {
  ...
  def all[T <: Tensor](axis: Double | js.Array[Double] = ???, keepDims: Boolean = ???): T = js.native
  def any[T <: Tensor](axis: Double | js.Array[Double] = ???, keepDims: Boolean = ???): T = js.native
  ...
  def unsortedSegmentSum[T <: Tensor](`this`: T, segmentIds: Tensor1D, numSegments: Double): T = js.native
  def batchToSpaceND[T <: Tensor](`this`: T, blockShape: js.Array[Double], crops: js.Array[js.Array[Double]]): T = js.native
  def spaceToBatchND[T <: Tensor](`this`: T, blockShape: js.Array[Double], paddings: js.Array[js.Array[Double]]): T = js.native
}
