...
package gpgpu_context {
  ...
  class GPGPUContext protected () extends js.Object {
    ...
    def maybeCreateBufferFromTexture(
        ...
        rows: Double,
        columns: Double
    ): WebGLBuffer | WebGLTexture              = js.native
    ...
    def getUniformLocation(
        ...
        uniformName: String,
        shouldThrow: Boolean = ???
    ): WebGLUniformLocation                                                    = js.native
    ...
    def setInputMatrixTexture(
        inputMatrixTexture: WebGLTexture,
        uniformLocation: WebGLUniformLocation,
        textureUnit: Double
    ): Unit = js.native
    def setOutputMatrixTexture(
        outputMatrixTexture: WebGLTexture,
        rows: Double,
        columns: Double
    ): Unit = js.native
    def setOutputPackedMatrixTexture(
        outputPackedMatrixTexture: WebGLTexture,
        rows: Double,
        columns: Double
    ): Unit = js.native
