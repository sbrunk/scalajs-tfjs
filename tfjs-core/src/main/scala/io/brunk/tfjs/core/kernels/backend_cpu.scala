...
class MathBackendCPU extends KernelBackend {
  ...
  def unsortedSegmentSum[T <: Tensor](x: T, segmentIds: Tensor1D, numSegments: Double): Tensor = js.native
  ...
  def spaceToBatchND[T <: Tensor](x: T, blockShape: js.Array[Double], paddings: js.Array[js.Tuple2[Double, Double]]): T = js.native
  ...
  def resizeBilinearBackprop(dy: Tensor4D, x: Tensor4D, alignCorners: Boolean): Tensor[Rank.R4] = js.native
  def resizeNearestNeighbor(x: Tensor4D, newHeight: Double, newWidth: Double, alignCorners: Boolean): Tensor4D = js.native
  def resizeNearestNeighborBackprop(dy: Tensor4D, x: Tensor4D, alignCorners: Boolean): Tensor[Rank.R4] = js.native
  ...
  def LRNGrad(dy: Tensor4D, inputImage: Tensor4D, outputImage: Tensor4D, depthRadius: Double, bias: Double, alpha: Double, beta: Double): Tensor4D = js.native
  ...
  def nonMaxSuppression(boxes: Tensor2D, scores: Tensor1D, maxOutputSize: Double, iouThreshold: Double, scoreThreshold: Double): Tensor1D = js.native
