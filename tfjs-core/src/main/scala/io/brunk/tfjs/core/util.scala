...
object Util extends js.Object {
  ...
  def flatten[T <: Double | Boolean | Promise[Double]](arr: T | RecursiveArray[T], ret: js.Array[T] = ???): js.Array[T] = js.native
  ...
  def checkComputationForNaN[D <: DataType](vals: js.Any, dtype: D, name: String): Unit = js.native
  def checkConversionForNaN[D <: DataType](vals: js.Any | js.Array[Double], dtype: D): Unit = js.native
  ...
  def toTypedArray[D <: DataType](a: ArrayData[D], dtype: D, debugMode: Boolean): js.Any = js.native
