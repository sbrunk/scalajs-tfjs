...
package loss_ops {
  ...
  object Loss_ops extends js.Object {
    def computeWeightedLoss_[T <: Tensor, O <: Tensor](
        losses: T | TensorLike,
        weights: Tensor | TensorLike = ???,
        reduction: Reduction = ???
    ): O = js.native
    def absoluteDifference_[T <: Tensor, O <: Tensor](
        labels: T | TensorLike,
        predictions: T | TensorLike,
        weights: Tensor | TensorLike = ???,
        reduction: Reduction = ???
    ): O = js.native
    def meanSquaredError_[T <: Tensor, O <: Tensor](
        labels: T | TensorLike,
        predictions: T | TensorLike,
        weights: Tensor | TensorLike = ???,
        reduction: Reduction = ???
    ): O = js.native
    def cosineDistance_[T <: Tensor, O <: Tensor](
        labels: T | TensorLike,
        predictions: T | TensorLike,
        axis: Double,
        weights: Tensor | TensorLike = ???,
    ...
    def hingeLoss_[T <: Tensor, O <: Tensor](
        labels: T | TensorLike,
        predictions: T | TensorLike,
        weights: Tensor | TensorLike = ???,
        reduction: Reduction = ???
    ): O = js.native
    def logLoss_[T <: Tensor, O <: Tensor](
        labels: T | TensorLike,
        predictions: T | TensorLike,
        weights: Tensor | TensorLike = ???,
        epsilon: Double = ???,
    ...
    def sigmoidCrossEntropy_[T <: Tensor, O <: Tensor](
    ...
    def huberLoss_[T <: Tensor, O <: Tensor](
        labels: T | TensorLike,
        predictions: T | TensorLike,
        weights: Tensor | TensorLike = ???,
        delta: Double = ???,
    ...
    def softmaxCrossEntropy_[T <: Tensor, O <: Tensor](
