...
package backend {
  ...
  trait MathBackend extends NDArrayStorage {
    ...
    def reverse4D(a: Array4D, axis: js.Array[Double]): Array4D                     = js.native
    ...
    def divide[D <: DataType](a: NDArray[D], b: NDArray[D]): NDArray[String]       = js.native
    ...
    def depthwiseConv2D(input: Array4D, filter: Array4D, convInfo: Conv2DInfo): Array4D = js.native
