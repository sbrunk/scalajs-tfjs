...
trait MathBackend extends NDArrayStorage {
  ...
  def clone[T <: NDArray[DataType, Rank]](ndarray: T): T                            = js.native
  ...
  def reverse4D(a: Array4D[DataType], axis: js.Array[Double]): Array4D[DataType]  = js.native
  ...
  def concat4D(a: Array4D[DataType], b: Array4D[DataType], axis: Double): Array4D[DataType] =
    js.native
  def neg[T <: NDArray[DataType, Rank]](a: T): T                                     = js.native
  ...
  def logicalOr(a: NDArray[DataType, Rank], b: NDArray[DataType, Rank]): NDArray[String, Rank] =
    js.native
  def topKValues[D <: DataType, T <: NDArray[D, Rank]](x: T, k: Double): Array1D[D]      = js.native
