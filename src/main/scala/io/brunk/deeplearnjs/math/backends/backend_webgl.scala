...
package backend_webgl {
  ...
  class MathBackendWebGL protected () extends MathBackend {
    ...
    def clone[D <: DataType, T <: NDArray[D]](x: T): T             = js.native
    ...
    def prelu[T <: NDArray](a: T, b: T): T                                         = js.native
    def preluDer[T <: NDArray](a: T, b: T): T                                      = js.native
    ...
    def avgPool(x: Array4D, convInfo: Conv2DInfo): Array4D[String]                  = js.native
    ...
    def multinomial(probs: Array2D, numSamples: Double, seed: Double): Array2D[String] = js.native
