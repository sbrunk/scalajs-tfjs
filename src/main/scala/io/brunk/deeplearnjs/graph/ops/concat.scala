...
@js.native
@JSGlobal
class Concat1D protected () extends Operation {
  def this(x1Tensor: Tensor, x2Tensor: Tensor, yTensor: Tensor) = this()
  def feedForward(math: NDArrayMath, inferecenArrays: TensorArrayMap): Unit = js.native
...
@js.native
@JSGlobal
class Concat2D protected () extends Operation {
...
@js.native
@JSGlobal
class Concat4D protected () extends Operation {
  def this(x1Tensor: Tensor, x2Tensor: Tensor, axis: Double, yTensor: Tensor) = this()
  def feedForward(math: NDArrayMath, inferecenArrays: TensorArrayMap): Unit = js.native
  def backProp(math: NDArrayMath,
               inferenceArrays: TensorArrayMap,
